...
The `/client` exports are the plugin body (`apply`/`inject`), `LayoutController`, and the three owner-share interfaces. AppFrame, the panel store, and the concession solver remain package-internal.
