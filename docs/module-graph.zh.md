...
flowchart TD
  ...
  pkg_matrix_theme --> pkg_invariants
...
| [`matrix-theme`](../packages/bundle/matrix-theme) | `bundle` | [`invariants`](../packages/runtime-diagnostics/invariants) |
