...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-matrix-theme': { kind: 'none', reason: 'Browser-side theme contribution; registers nothing model-facing.' },
  ...
  'packages/bundle/matrix-theme': { kind: 'indirect', reason: 'The bundle is a one-row patch carrier; the theme package owns its browser-side behavior and registers nothing model-facing.' },
  ...
  'packages/util/uuid': { kind: 'none', reason: 'Pure id-generation primitive; registers nothing model-facing.' },
